...
nvcc hd_encoder.cu hd_batch_encoder.cu hd_classifier.c test_inference.c -o test_inference $nvccflags
nvcc hd_encoder.cu hd_batch_encoder.cu hd_classifier.c -o hdlib_$(uname -m).so $nvccflags $linkflags
